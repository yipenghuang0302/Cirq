...
def main():
    ...
    circuit = cirq.Circuit(cirq.
    (q0), cirq.CNOT(q0,q1), cirq.measure(q0), cirq.measure(q1))
    simulator = cirq.KnowledgeCompilationSimulator(circuit, initial_state=0, dtype=np.complex64)
    for _ in range(10):
