...
def main():
    ...
    sv_results = sv_sim.run(circuit, repetitions=20)
    print("\nResults:")
    print(sv_results)

    kc_sim = cirq.KnowledgeCompilationSimulator(circuit,intermediate=True)
    kc_results = kc_sim.run(circuit, repetitions=20)
    print("\nResults:")
    print(kc_results)
