...
def _estimate_pauli_traces_general(qubits: List[cirq.Qid],
    ...
    dense_simulator = cirq.KnowledgeCompilationSimulator(circuit) # cirq.DensityMatrixSimulator()
...
def direct_fidelity_estimation(circuit: cirq.Circuit, qubits: List[cirq.Qid],
    ...
    noisy_simulator = cirq.KnowledgeCompilationSimulator(circuit, noise=noise) # cirq.DensityMatrixSimulator(noise=noise)
    print("HERE fidelity = 0.0")
    fidelity = 0.0
